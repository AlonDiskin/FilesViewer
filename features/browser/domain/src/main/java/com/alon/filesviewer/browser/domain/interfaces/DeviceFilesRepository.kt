...
interface DeviceFilesRepository {
    ...
    fun getFolder(path: String, showHiddenFiles: Boolean): Observable<Result<List<DeviceFile>>>

    fun search(query: String, filter: SearchFilter, showHiddenFiles: Boolean): Observable<Result<List<DeviceFile>>>
}