...
class DeviceFilesBrowsedStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                ...
                .withTags("@browse-category-files")
                .scenarios()
    ...
    @Inject
    lateinit var fakeMediaStoreContentProvider: FakeMediaStoreContentProvider

    @Test
    fun test() {
        hiltRule.inject()
        start(DeviceFilesBrowsedSteps(fakeMediaStoreContentProvider))
    }
}