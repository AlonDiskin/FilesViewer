...
@OptionalInject
@AndroidEntryPoint
class CollectionBrowserFragment : Fragment(R.layout.fragment_browser) {

    private val viewModel: CollectionBrowserViewModel by viewModels()
    ...
    private fun showFileDetail(file: DeviceFile) {
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(getString(R.string.button_dialog_positive)) { dialog, _ ->
