...
import com.alon.filesviewer.browser.ui.controller.FolderBrowserFragment
...
class FolderBrowserFragmentTest {
    ...
    // Collaborators
    private val viewModel: FolderBrowserViewModel = mockk()
    ...
    fun setUp() {
        ...
        scenario = launchFragmentInHiltContainer<FolderBrowserFragment>()
        Shadows.shadowOf(Looper.getMainLooper()).idle()
    }

    @Test
    fun showDeviceRootFolderAsDefault_WhenDisplayed() {
        // Given
        val files = listOf(
    ...
    @Test
    fun showDeviceFolderFiles_WhenFolderSelectedByUser() {
        // Given
        val files = listOf(
        ...
        every { viewModel.navToFolder(any()) } returns Unit
        ...
        // Then
        verify { viewModel.navToFolder(files.first().path) }
    }

    @Test
    fun showCurrentFolderPath_WhenFolderBrowsed() {
        // Given
    ...
    @Test
    fun showError_WhenUserBrowseToRestrictedFolder() {
        // Given
    ...
    @Test
    fun showError_WhenUserBrowseToNonExistingFolder() {
        // Given
    ...
    @Test
    fun navUpFromFolder_WhenBackPressed_AndFolderHasParent() {
        // Given

        every { viewModel.isRootFolder() } returns false
        every { viewModel.navUpFromFolder() } returns Unit
        ...
        // Then
        verify(exactly = 1) { viewModel.navUpFromFolder() }
    }

    @Test
    fun callActivityBackPress_WhenBackPressed_AndFolderHasNoParent() {
        // Given
